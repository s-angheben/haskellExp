...
/* package imperative-cps-0.1.0.0 */
#ifndef VERSION_imperative_cps
#define VERSION_imperative_cps "0.1.0.0"
#endif /* VERSION_imperative_cps */
#ifndef MIN_VERSION_imperative_cps
#define MIN_VERSION_imperative_cps(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_imperative_cps */
...
#define CURRENT_COMPONENT_ID "imperative-cps-0.1.0.0-inplace-imperative-cps"
