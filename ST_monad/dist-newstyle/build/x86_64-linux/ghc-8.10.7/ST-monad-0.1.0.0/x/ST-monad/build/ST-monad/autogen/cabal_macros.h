...
/* package ST-monad-0.1.0.0 */
#ifndef VERSION_ST_monad
#define VERSION_ST_monad "0.1.0.0"
#endif /* VERSION_ST_monad */
#ifndef MIN_VERSION_ST_monad
#define MIN_VERSION_ST_monad(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ST_monad */
...
#define CURRENT_COMPONENT_ID "ST-monad-0.1.0.0-inplace-ST-monad"
