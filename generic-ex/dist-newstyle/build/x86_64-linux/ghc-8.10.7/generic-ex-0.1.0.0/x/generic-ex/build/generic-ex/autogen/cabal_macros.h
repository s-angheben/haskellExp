...
/* package generic-ex-0.1.0.0 */
#ifndef VERSION_generic_ex
#define VERSION_generic_ex "0.1.0.0"
#endif /* VERSION_generic_ex */
#ifndef MIN_VERSION_generic_ex
#define MIN_VERSION_generic_ex(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_generic_ex */
...
#define CURRENT_COMPONENT_ID "generic-ex-0.1.0.0-inplace-generic-ex"
